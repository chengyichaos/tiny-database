...
# syl_db = Database('syl_db')
# syl_db.create_table(
#     table_name='syl_table',
#     f_id=Field(type=FieldType.INT, keys=[FieldKey.PRIMARY, FieldKey.INCREMENT]),
#     f_name=Field(type=FieldType.VARCHAR, keys=FieldKey.NOT_NULL)
# )
